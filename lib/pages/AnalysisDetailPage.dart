...
import 'package:admin/pages/PatternDescriptionPage.dart';
...
class _AnalysisDetailPageState extends State<AnalysisDetailPage> {
  ...
  Widget reco() {
    ...
    if (_call.advisor_accuracy != null && _call.advisor_accuracy != "null") {
      double acc = double.parse(_call.advisor_accuracy);
      if (acc < 50) {
        premium = Container();
      } else {
        premium = ShapeOfView(
            ...
            child: Consumer<ProfileInfoServices>(
              ...
              return ListTile(
                leading: CircleAvatar(
                  ...
                  child: Image.network(snapshot.geturl() == null
                      ? personImage
                      : snapshot.geturl()),
                ),
                title: Text(
                  snapshot.getFName() + " " + snapshot.getLName(),
                  maxLines: 2,
        ...
        Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: ColorsTheme.darkred, width: 5)),
              child: Padding(
                padding: const EdgeInsets.all(8.0),
