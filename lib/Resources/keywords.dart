...
const String homeScree = baseUrl + "/advisorcountprofile";
...
const String finstruments = websocketUrl+ "/get/search";
const String settoken = baseUrl+ "/settoken";
const String tradertoadvisor = baseUrl+ "/tradertoadvisor";
...
class Strings {
  ...
  static const String buySell = "tradetype";
